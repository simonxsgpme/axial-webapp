...
class Campaign extends Model
{
    ...
    public function getStatusColorAttribute(): string
    {
        return match ($this->status) {
            ...
            'midterm_in_progress' => 'primary',
            'midterm_completed' => 'info',
            'evaluation_in_progress' => 'primary',
    ...
    public function getNextActionAttribute(): ?array
    {
        return match ($this->status) {
            ...
            'objective_completed' => ['action' => 'start-midterm', 'label' => 'Démarrer l\'éval. mi-parcours', 'icon' => 'fi-rr-play', 'color' => 'primary'],
            'midterm_in_progress' => ['action' => 'complete-midterm', 'label' => 'Terminer l\'éval. mi-parcours', 'icon' => 'fi-rr-check', 'color' => 'info'],
            'midterm_completed' => ['action' => 'start-evaluations', 'label' => 'Démarrer les évaluations finales', 'icon' => 'fi-rr-play', 'color' => 'primary'],
